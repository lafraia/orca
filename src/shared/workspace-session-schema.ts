...
const terminalTabSchema = z.object({
  ...
  customTitleAt: z.number().optional(),
  agentSessionTitle: z.string().nullable().optional(),
  agentSessionTitleAt: z.number().optional(),
...
const tabSchema = z.object({
  ...
  customLabelAt: z.number().optional(),
  agentSessionLabel: z.string().nullable().optional(),
  agentSessionLabelAt: z.number().optional(),
  color: z.string().nullable(),
  sortOrder: z.number(),
  createdAt: z.number(),
